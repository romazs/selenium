...
first_last_name_seven = [["Sevennn", "Aaaa", "test223344@walla.co.il", "rom0123"], ["Aaaa", "Sevennn", "test332255@gmail.com", "mor3210"]]


@pytest.mark.parametrize("users", first_last_name_seven)
def test_sign_up(setup, users):
    driver = setup
    ...
    #Sign up: first name 7 chars and last name 7 chars. walla and gmail.


time.sleep(5)


def test_sign_up_password_ten_chars(setup):
    driver = setup
    driver.find_element(By.XPATH, '//button[text()="Sign Up"]').click()
    driver.find_element(By.XPATH, '//input[@placeholder="Type your first name"]').send_keys("Romaaan")
    driver.find_element(By.XPATH, '//input[@placeholder="Type your last name"]').send_keys("Kharik")
    driver.find_element(By.XPATH, '//input[@placeholder="Enter your email"]').send_keys("roman003@gmail.com")
    driver.find_element(By.XPATH, '//input[@placeholder = "Create Password"]').send_keys("a12345677!")
    driver.find_element(By.XPATH, '//input[@placeholder="Confirm Password"]').send_keys("a12345677!")
    driver.find_element(By.XPATH, '//button[@type="submit"]').click()
    assert driver.find_element(By.XPATH, '//h5[text()="Combo Meal"]').is_displayed()
...
def test_sign_up_with_yahoo(setup):
    ...
    driver.find_element(By.XPATH, '//input[@placeholder="Enter your email"]').send_keys("roman004@yahoo.com")
    driver.find_element(By.XPATH, '//input[@placeholder = "Create Password"]').send_keys("1234rom")
    driver.find_element(By.XPATH, '//input[@placeholder="Confirm Password"]').send_keys("1234rom")
    driver.find_element(By.XPATH, '//button[@type="submit"]').click()
    assert driver.find_element(By.XPATH, '//h5[text()="Combo Meal"]').is_displayed()
...
def test_sign_in_password_ten_chars(setup):
    ...
    driver.find_element(By.XPATH, '//button[text()="Sign In"]').click()
    driver.find_element(By.XPATH, '//input[@placeholder="Enter your email"]').send_keys("roman003@gmail.com")
    driver.find_element(By.XPATH, '//input[@placeholder="Enter your password"]').send_keys("a12345677!")
    driver.find_element(By.XPATH, '//button[text()="Sign in"]').click()
    assert driver.find_element(By.XPATH, '//h5[text()="Combo Meal"]').is_displayed()
    # connected to sign_up_password_ten_chars
